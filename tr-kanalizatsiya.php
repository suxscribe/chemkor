            ...
            <div id="tabs" class="uk-switcher uk-margin-minus ">
                <div class="obsadnyye-block">
                    ...
                    <div class="obsadnyye-add uk-hidden-medium">
                        <button class="uk-button button-obsadnyye icon-plus " type="button" data-uk-toggle="{target:'#info-01'}"></button>
                        <div id="info-01" class="uk-hidden obsadnyye-add-content">
