<?php include 'header.php'; ?>
    ...
    <main>
        ...
        <div class="uk-container container-965 uk-margin-large-bottom">
            <h1 class="block-fullwidth-heading h1-titke">Ливневая канализация</h1>
        ...
        <div class="uk-container container-1160 uk-margin-large-bottom uk-position-relative">
            ...
            <ul class="uk-tab uk-tab-grid uk-tab__obsadnyye" data-uk-switcher="{connect:'#obsadnyye'}">
                <li class="uk-width-1-3 uk-active"><a href="">Многоквартирный дом</a></li>
                <li class="uk-width-1-3"><a href="">Торговый центр</a></li>
                <li class="uk-width-1-3"><a href="">Частный дом</a></li>
            </ul>

            <div id="obsadnyye" class="uk-switcher uk-margin-minus ">
                <div class="obsadnyye-block">
                    <img src="images/tr-livnevka_mnogokvartirny.jpg" alt="obsadnyye-truby-pic-full">

                    <div class="obsadnyye-add uk-hidden-small uk-hidden-medium" style="top:78%;left:41%;">
                        <button class="uk-button button-obsadnyye icon-plus" type="button" data-uk-toggle="{target:'#obsadnyye-info1'}"></button>
                        <div id="obsadnyye-info1" class="uk-hidden obsadnyye-add-content" style="top:-270px;left:-70px;">
                            <button type="button" class="icon-plus obsadnyye-add-close" data-uk-toggle="{target:'#obsadnyye-info1'}"></button>
                            <img src="images/tr-livnevka_mnogokvartirny_fragment.jpg" alt="">
                ...
                <div class="obsadnyye-block">
                    ...
                    <div class="obsadnyye-add uk-hidden-small uk-hidden-medium" style="top:59%;left:55%;">
                        ...
                        <div id="obsadnyye-info2" class="uk-hidden obsadnyye-add-content" style="top:-270px;left:-205px;">
                            <button type="button" class="icon-plus obsadnyye-add-close" data-uk-toggle="{target:'#obsadnyye-info2'}"></button>
                            <img src="images/tr-livnevka_dorogi_fragment.jpg" alt="">
                            <p>Описание конструкции <br>
                                Комплектуются скважинными фильтрами и оголовками. Бурение скважин с применением труб ПВХ
                                позволяет избегать загрязнения подземных вод, а также увеличивает скорость бурения по сравнению
                                с металлическими и полиэтиленовыми трубами.</p>
                ...
                <div class="obsadnyye-block">
                    <img src="images/tr-livnevka_dom.jpg" alt="obsadnyye-truby-pic-full">

                    <div class="obsadnyye-add uk-hidden-small uk-hidden-medium" style="top:72%;left:44%;">
                        <button class="uk-button button-obsadnyye icon-plus" type="button" data-uk-toggle="{target:'#obsadnyye-info3'}"></button>
                        <div id="obsadnyye-info3" class="uk-hidden obsadnyye-add-content" style="top:-270px;left:-85px;">
                            <button type="button" class="icon-plus obsadnyye-add-close" data-uk-toggle="{target:'#obsadnyye-info3'}"></button>
                            <img src="images/tr-livnevka_dom_fragment.jpg" alt="">
                            <p>Описание конструкции <br>
                                Комплектуются скважинными фильтрами и оголовками. Бурение скважин с применением труб ПВХ
                                позволяет избегать загрязнения подземных вод, а также увеличивает скорость бурения по сравнению
                                с металлическими и полиэтиленовыми трубами.</p>
