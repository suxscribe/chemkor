    ...
    <main>
                        ...
                        <li>
                            <div class="catalog-item_slider">
                                ...
                                <div class="catalog-item_slider-content">
                                    ...
                                    <div class="catalog-item_slider-button">
                                        <a href="" class="uk-button button_chevron button_white">В Каталог</a>
                                    </div>
                                </div>
                                <a href="" class="uk-position-cover"></a>
                            </div>
        ...
        <div class="uk-container container-780 resheniya-562  uk-margin-large-bottom">
            ...
            <p class="resheniya-botton-content" data-uk-scrollspy="{cls:'uk-animation-slide-bottom',delay:750}">Специалисты компании успешно обеспечивают инженерное сопровождение проектов и комплектацию
                ...
                сократить сроки их сдачи (в том числе за счет транспортных перевозок и таможенного оформления
                товара)</p>
        </div>
