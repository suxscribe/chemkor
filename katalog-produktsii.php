                    ...
                    <ul class="header-list header-list__katalog uk-column-1-1 uk-column-medium-1-2" data-uk-scrollspy="{cls:'uk-animation-slide-bottom',delay:250}">
                        <li class="header-item">
                            <a href="">
                                ...
                                <div class="header-item-text">ПОЛНЫЙ КАТАЛОГ ПРОДУКЦИИ</div>
                            </a>
                        </li>
            ...
            <div class="uk-grid uk-grid-width uk-grid-width-small-1-2 uk-block-product uk-block-product__katalog" data-uk-grid-margin data-uk-scrollspy="{cls:'uk-animation-slide-bottom',delay:750}">
                <div>
                    <div class="uk-card-product">
                        <p>Напорные трубы</p>
                        <img src="images/catalog-produkt-1.png" alt="produkt">
                ...
                <div>
                    <div class="uk-card-product">
                        <p>Наружная канализация</p>
                        <img src="images/catalog-produkt-2.png" alt="produkt">
                        <a href="" class="uk-position-cover"></a>
                    </div>
                </div>
                ...
                <div>
                    <div class="uk-card-product">
                        <p>Обсадные трубы, фильтры, оголовок</p>
                        <img src="images/catalog-produkt-3.png" alt="produkt">
                        <a href="" class="uk-position-cover"></a>
                    </div>
                </div>
                ...
                <div>
                    <div class="uk-card-product">
                        ...
                        <img src="images/catalog-produkt-4.png" alt="produkt">
                        <a href="" class="uk-position-cover"></a>
                    </div>
                </div>
                ...
                <div>
                    <div class="uk-card-product">
                        <p>Шланги для орошения</p>
                        <img src="images/catalog-produkt-5.png" alt="produkt">
                        <a href="" class="uk-position-cover"></a>
                    </div>
                </div>
